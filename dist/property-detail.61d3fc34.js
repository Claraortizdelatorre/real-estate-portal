...
exports.isValidContact = exports.getProperty = exports.getEquipment = void 0;
...
var isValidContact = function isValidContact(form) {
...
},{}],"pages/property-detail/property-detail.mappers.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.mapPropertyFromApiToVM = void 0;
var mapPropertyFromApiToVM = function mapPropertyFromApiToVM(property, equipmentsList) {
  return {
...
exports.mapPropertyFromApiToVM = mapPropertyFromApiToVM;
...
var transformEquipment = function transformEquipment(property, equipmentsList) {
  var equipments = property.equipmentIds.map(function (obj) {
    return equipmentsList.find(function (element) {
...
},{"./element.helpers":"common/helpers/element.helpers.js"}],"pages/property-detail/property-detail.js":[function(require,module,exports) {
"use strict";

var _router = require("../../core/router");
var _propertyDetail = require("./property-detail.api");
var _propertyDetail2 = require("./property-detail.helpers");
var _propertyDetail3 = require("./property-detail.mappers");
...
//lo paso a mappers
Promise.all([(0, _propertyDetail.getProperty)(params.id), (0, _propertyDetail.getEquipment)()]).then(function (_ref) {
  var _ref2 = _slicedToArray(_ref, 2),
    propertyList = _ref2[0],
    equipmentList = _ref2[1];
  loadProperty(propertyList, equipmentList);
});
var loadProperty = function loadProperty(propertyList, equipmentList) {
...
var resetForm = function resetForm() {
  var form = document.getElementsByClassName('form-detalle-propiedad');
  form[0].reset();
};
...
(0, _helpers.onSubmitForm)('contact-button', function () {
  _propertyDetail4.formValidation.validateForm(form).then(function (result) {
    ...
    if (result.succeeded) {
      (0, _propertyDetail.isValidContact)(form).then(function (isValid) {
        onNavigate(isValid);
        resetForm();
      });
    }

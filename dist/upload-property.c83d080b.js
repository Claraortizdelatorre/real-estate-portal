...
exports.saveProperty = exports.getSaleTypeList = exports.getProvinceList = exports.getEquipment = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var url = "".concat("http://localhost:3000/api", "/properties");
var saveProperty = function saveProperty(newProperty) {
  return _axios.default.post(url, newProperty).then(function (response) {
...
var equipmentsUrl = "".concat("http://localhost:3000/api", "/equipments");
var getEquipment = function getEquipment() {
  return _axios.default.get(equipmentsUrl).then(function (response) {
    return response.data;
  });
};
...
},{"./element.helpers":"common/helpers/element.helpers.js"}],"pages/upload-property/upload-property.helpers.js":[function(require,module,exports) {
"use strict";
...
exports.mapPropertyFromVMToApi = void 0;
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
function _defineProperty(obj, key, value) { key = _toPropertyKey(key); if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var mapPropertyFromVMToApi = function mapPropertyFromVMToApi(property) {
...
exports.mapPropertyFromVMToApi = mapPropertyFromVMToApi;
...
var _uploadProperty4 = require("./upload-property.validations");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
function _nonIterableSpread() { throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _iterableToArray(iter) { if (typeof Symbol !== "undefined" && iter[Symbol.iterator] != null || iter["@@iterator"] != null) return Array.from(iter); }
...
function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
//cargar
Promise.all([(0, _uploadProperty.getSaleTypeList)(), (0, _uploadProperty.getProvinceList)(), (0, _uploadProperty.getEquipment)()]).then(function (resultList) {
  var _resultList = _slicedToArray(resultList, 3),
    saleTypeList = _resultList[0],
    provinceList = _resultList[1],
    equipmentList = _resultList[2];
  (0, _uploadProperty2.setCheckboxList)(saleTypeList, 'saleTypes');
...
(0, _helpers.onUpdateField)('title', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('title', property.title).then(function (result) {
...
(0, _helpers.onUpdateField)('notes', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('notes', property.notes).then(function (result) {
...
(0, _helpers.onUpdateField)('email', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('email', property.email).then(function (result) {
...
(0, _helpers.onUpdateField)('phone', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('phone', property.phone).then(function (result) {
...
(0, _helpers.onUpdateField)('price', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('price', property.price).then(function (result) {
...
(0, _helpers.onUpdateField)('address', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('address', property.address).then(function (result) {
...
(0, _helpers.onUpdateField)('city', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('city', property.city).then(function (result) {
...
(0, _helpers.onUpdateField)('province', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('province', property.province).then(function (result) {
...
(0, _helpers.onUpdateField)('squareMeter', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('squareMeter', property.squareMeter).then(function (result) {
...
(0, _helpers.onUpdateField)('rooms', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('rooms', property.rooms).then(function (result) {
...
(0, _helpers.onUpdateField)('bathrooms', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('bathrooms', property.bathrooms).then(function (result) {
...
(0, _helpers.onUpdateField)('locationUrl', function (event) {
  ...
  _uploadProperty4.formValidation.validateField('locationUrl', property.locationUrl).then(function (result) {
...
(0, _helpers.onAddFile)('add-image', function (image) {
  (0, _uploadProperty2.onAddImage)(image);
  property = _objectSpread(_objectSpread({}, property), {}, {
    images: [].concat(_toConsumableArray(property.images), [image])
  });
});
...
(0, _helpers.onSubmitForm)('save-button', function () {
  ...
  _uploadProperty4.formValidation.validateForm(property).then(function (result) {
    (0, _helpers.onSetFormErrors)(result);
    var mappedProperty = (0, _uploadProperty3.mapPropertyFromVMToApi)(property);
...
},{"./upload-property.api":"pages/upload-property/upload-property.api.js","../../common/helpers":"common/helpers/index.js","./upload-property.helpers":"pages/upload-property/upload-property.helpers.js","./upload-property.mappers":"pages/upload-property/upload-property.mappers.js","./upload-property.validations":"pages/upload-property/upload-property.validations.js"}],"../node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
